...
-- ecb_exchange_rates."user" definition
...
CREATE INDEX "IDX_2387c9918a254fab9d69377324" ON ecb_exchange_rates."user" USING btree (requests);
...
-- ecb_exchange_rates.user_activity definition
...
-- ecb_exchange_rates.exchange_rates definition
